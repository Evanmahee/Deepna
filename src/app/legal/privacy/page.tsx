  ...
  return (
    <div className="mx-auto max-w-2xl px-4 py-10 pb-28 text-slate-700">
      ...
      <section className="mt-8 space-y-4 text-sm leading-relaxed">
        <h2 className="text-lg font-medium text-slate-900">1. Responsable du traitement</h2>
        <p>
        ...
        <h2 className="text-lg font-medium text-slate-900">2. Données collectées</h2>
        ...
        <h2 className="text-lg font-medium text-slate-900">3. Finalités</h2>
        <p>
        ...
        <h2 className="text-lg font-medium text-slate-900">4. Base légale (RGPD)</h2>
        <p>
        ...
        <h2 className="text-lg font-medium text-slate-900">5. Conservation</h2>
        <p>
        ...
        <h2 className="text-lg font-medium text-slate-900">6. Vos droits</h2>
        <p>
        ...
        <h2 className="text-lg font-medium text-slate-900">7. Sous-traitants</h2>
        <p>
