...
export default function TermsPage() {
  return (
    <div className="mx-auto max-w-2xl px-4 py-10 pb-28 text-neutral-300">
      ...
      <p className="mt-2 text-sm text-neutral-400">Dernière mise à jour : juin 2026</p>

      <section className="mt-8 space-y-4 text-sm leading-relaxed">
        <h2 className="text-lg font-medium text-white">1. Objet</h2>
        <p>
        ...
        <h2 className="text-lg font-medium text-white">2. Compte utilisateur</h2>
        <p>
        ...
        <h2 className="text-lg font-medium text-white">3. Usage acceptable</h2>
        <p>
        ...
        <h2 className="text-lg font-medium text-white">4. Propriété intellectuelle</h2>
        <p>
        ...
        <h2 className="text-lg font-medium text-white">5. Disponibilité</h2>
        <p>
        ...
        <h2 className="text-lg font-medium text-white">6. Limitation de responsabilité</h2>
        <p>
        ...
        <h2 className="text-lg font-medium text-white">7. Résiliation</h2>
        <p>
        ...
        <p>
          ...
          <a href="mailto:contact@deepna.app" className="text-indigo-400">
            contact@deepna.app
          </a>
          .
        </p>
